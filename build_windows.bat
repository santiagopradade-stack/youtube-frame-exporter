...
python -m PyInstaller --noconfirm --clean --onefile --windowed --name YouTubeFrameExporter --add-binary "deno.exe;." --collect-all imageio_ffmpeg --collect-all yt_dlp --collect-all yt_dlp_ejs app.py
if errorlevel 1 goto :failed
